...
**Генерация: короткая идея → улучшенный промпт → картинка (Flux)**

![Генерация изображения](docs/img/01-generate.png)

**Редактирование фото по инструкции (Flux Kontext): замена фона, лицо сохранено**

![Редактирование фото](docs/img/02-edit-kontext.png)

<details>
<summary>Ещё интерфейс — меню, конструктор промпта, стили</summary>

**Главное меню**

![Меню](docs/img/03-menu.png)

**Пошаговый конструктор промпта**

![Конструктор промпта](docs/img/04-wizard.png)

**Помощь по промптам и пресеты стилей**

![Помощь и стили](docs/img/05-styles.png)
